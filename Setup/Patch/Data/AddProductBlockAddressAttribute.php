...
/**
 * Data patch: adds product attribute 'block_inpostinternational_address'.
 */
class AddProductBlockAddressAttribute implements DataPatchInterface, PatchRevertableInterface
{
    public const ATTRIBUTE_CODE = 'block_inpostinternational_address';
    protected const GROUP_NAME = 'General';
    protected const SORT_ORDER = 33767;
    ...
    protected function attributeDefinition(): array
    {
        return [
            'type'    => 'int',
            'label'   => 'Block send with InPost International to address',
            'input'   => 'boolean',
