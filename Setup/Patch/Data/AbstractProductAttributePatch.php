...
abstract class AbstractProductAttributePatch implements DataPatchInterface, PatchRevertableInterface
{
    protected const GROUP_NAME = 'General';
    protected const SORT_ORDER = 33765;

    /**
     * AbstractProductAttributePatch constructor.
     *
     ...
     */
    public function apply(): AbstractProductAttributePatch
    {
        $this->db()->startSetup();
        try {
    ...
    /**
     * Reverts the changes made by the apply() method by removing the attribute.
     *
     * @return void
     */
    ...
    /**
     * The attribute code to be added or removed.
     *
     * @return string
     */
    abstract protected static function attributeCode(): string;

    /**
     * The definition of the attribute to be added.
     *
     * @return array
     */
    abstract protected function attributeDefinition(): array;
