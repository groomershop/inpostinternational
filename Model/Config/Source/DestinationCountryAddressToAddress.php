...
class DestinationCountryAddressToAddress extends DestinationCountry implements OptionSourceInterface
{
    /**
    ...
    public function toOptionArray(): array
    {
        ...
        $allowedCountries = $this->countrySettings->getCountryCanInPostShipAddressToAddressSettings();
        return array_filter(
            $options,
