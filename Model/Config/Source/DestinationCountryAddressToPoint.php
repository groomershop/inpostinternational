...
class DestinationCountryAddressToPoint extends DestinationCountry implements OptionSourceInterface
{
    /**
    ...
    public function toOptionArray(): array
    {
        ...
        $allowedCountries = $this->countrySettings->getCountryCanInPostShipAddressToPointSettings();
        return array_filter(
            $options,
