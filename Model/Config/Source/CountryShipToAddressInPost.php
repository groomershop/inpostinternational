...
class CountryShipToAddressInPost extends CountryShip implements OptionSourceInterface
{
    /**
     * Countries
     *
    ...
    {
        $allCountries = $this->countrySettings->getCountryCanInPostShipToAddressSettings();
