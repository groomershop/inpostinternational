...
class DestinationCountryPointToAddress extends DestinationCountry implements OptionSourceInterface
{
    /**
    ...
    public function toOptionArray(): array
    {
        ...
        $allowedCountries = $this->countrySettings->getCountryCanInPostShipPointToAddressSettings();
        return array_filter(
            $options,
